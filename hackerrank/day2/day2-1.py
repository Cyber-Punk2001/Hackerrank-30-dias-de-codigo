def calcular_total(precio, propina, impuesto):
...
for i in range(cantidad):
    ...
    impuesto = int(input("Porcentaje de impuesto: "))

    monto_propina, monto_impuesto, total = calcular_total(
        precio,
        propina,
        impuesto
    )
...
Propina  : RD${producto['propina']:.2f}
Impuesto : RD${producto['impuesto']:.2f}
...
print(f"Total Impuestos    : RD${total_impuestos:.2f}")
